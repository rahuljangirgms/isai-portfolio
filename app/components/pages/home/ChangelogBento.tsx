...
export function ChangelogBento() {
  // Dummy data for changelog items
  const changelogItems = [
    {
      title: "Feature Update: New Homepage Design",
      publishedAt: "2025-06-01",
    },
    {
      title: "Bug Fix: Improved Page Load Speed",
      publishedAt: "2025-05-20",
    },
    {
      title: "New Blog Post: Understanding TypeScript",
      publishedAt: "2025-04-15",
    },
    {
      title: "Changelog: API Changes and Updates",
      ...
      <div className="relative">
        <div className="absolute left-0 right-0 top-0 transition-transform duration-500 ease-in-out group-hover:-translate-y-6">
          {changelogItems.map((item, index) => (
            ...
            >
              <span
                className={`absolute top-[27px] ${index % 2 === 1 ? "left-[-20px]" : "right-[-20px]"
...
}: Partial<{ title: string; publishedAt: string }>) {
  return (
