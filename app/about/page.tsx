...
import { HorizontalLine } from "@/app/components/pages/about/HorizontalLine";
import { getTimeOfDayGreeting } from "@/app/lib/utils";
import React from "react";
import { CurrentlyPlayingBento } from "@/app/components/pages/about/CurrentlyPlayingBento";
import { ConnectionsBento } from "@/app/components/pages/home/ConnectionsBento";
import { ScrapbookBento } from "@/app/components/pages/about/ScrapbookBento";
import { ShadowBox } from "@/app/components/pages/home/ShadowBox";
import { Resume } from "@/app/components/pages/about/Resume";
import { StatsBento } from "@/app/components/pages/about/StatsBento";
import { CurrentlyReadingBento } from "@/app/components/pages/about/CurrentlyReadingBento";
import { GridWrapper } from "@/app/components/pages/home/GridWrapper";
import { AboutTrackPattern } from "@/app/components/pages/about/AboutTrackPattern";
import { Photo } from "@/app/components/pages/home/Photo";
...
export default function AboutPage() {
  ...
  return (
    <div className="relative mt-14">
      <title>About | Rahul Jangir</title>
          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-around lg:px-24">
            <div className="order-2 mx-auto max-w-lg lg:order-1 lg:m-0 lg:max-w-3xl lg:pr-12">
              ...
              <h1 className="mx-auto max-w-2xl text-balance text-center text-4xl font-medium leading-tight tracking-tighter text-text-primary md:text-5xl lg:text-left lg:text-6xl lg:leading-[64px]">
                I&apos;m Rahul, a creative frontend engineer.
              </h1>
            </div>
